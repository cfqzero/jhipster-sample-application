package lcy.repository;

import lcy.JHiApp;
import lcy.config.Constants;
import lcy.config.audit.AuditEventConverter;
import lcy.domain.PersistentAuditEvent;
...
import static lcy.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
